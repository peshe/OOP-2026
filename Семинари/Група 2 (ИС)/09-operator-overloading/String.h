...
// We could also write the operator+ as a free function.
// Note: Do not write operators as BOTH FREE AND MEMBER functions!
// If you write both versions - the compiler won't know which one to call!
//  -> Write only one of the two versions.
//
