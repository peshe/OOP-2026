...
- operator `(bool)` - връща false, ако вектора е нулевия вектор. В противен случай връща true.
- `++` - добавя +1 на всяко число във вектора.
-  `==`, `!=` - 2 вектора са равни, ако всичките им елементи са равни.
- `<`, `>=`, `>`, `<=` - сравняват векторите по сумата на елементите им.  
...
### Задача 3  (интересна, но дълга задачка)
