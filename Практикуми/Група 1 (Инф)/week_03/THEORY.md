...
Извод - последователен достъп до файлове ще използваме, когато искаме да запишем голям обем от данни, като предварително знаем, че промяна няма да има или ще е на много редки интервали, тъй като промяната е много бавна операция
=======
